...
public class MainActivity extends Activity implements OnClickListener, OnCheckedChangeListener,
    ...
    public void draw(View view) {
        startActivity(new Intent(getApplicationContext() ,PageViewActivity.class));
    }
    private void init() {
...
//        Log.v("MainActivity","BASS_CONFIG_NET_PROXY::"+FmlPlayer.getGlobalOptions(BASS.BASS_CONFIG_NET_PROXY));
    ...
    private void loadView() {
        ...
        url.setText("http://vip.baidu190.com/uploads/2017/20170162b5ae89f3175c8b6fd33067b9e45e5e.mp3");
//        url.setText("https://github.com/ViTess/Android-FmlPlayer/tree/master/demo/testAudio/src/main/assets/pink.ogg");
    }
